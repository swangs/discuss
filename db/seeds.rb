...
User.create(username: "user8", password: "password")
...
Server.create(name: "user6Server", owner_id: 8, direct_message: true)
Server.create(name: "user7Server", owner_id: 9, direct_message: true)
Server.create(name: "user8Server", owner_id: 10, direct_message: true)
