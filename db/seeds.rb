...
Channel.create(name: "Welcome to Discuss", server_id: 6)
Channel.create(name: "Welcome to Discuss", server_id: 7)
Channel.create(name: "Welcome to Discuss", server_id: 8)
