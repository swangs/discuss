...
Message.create(content: "Send direct messages by clicking on a user in the member's list.", author_id: 1, channel_id: 1)
...
Message.create(content: "Send direct messages by clicking on a user in the member's list.", author_id: 1, channel_id: 2)
...
Message.create(content: "Send direct messages by clicking on a user in the member's list.", author_id: 1, channel_id: 3)
...
Message.create(content: "Send direct messages by clicking on a user in the member's list.", author_id: 1, channel_id: 4)
...
Channel.create(name: "chat about anything", server_id: 8)
